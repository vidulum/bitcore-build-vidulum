...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-vidulum/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:' + fullname + ' --external bitcore-lib-vidulum -o ' + fullname + '.js';
    } else {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:bitcore-lib-vidulum -o bitcore-lib-vidulum.js';
    }
